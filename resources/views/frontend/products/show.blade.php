                        ...
                        <div class="col-sm-5">
                            <div class="view-product">
                                <img src="{{ asset('storage/products/full/' . $product->images->first()->image) }}"
                                    id="mainImage" alt="" />
                                <a href="{{ asset('storage/products/full/' . $product->images->first()->image) }}"
                                    id="zoomImage" rel="prettyPhoto">
                                    <h3>ZOOM</h3>
                                </a>
                            </div>
                                    ...
                                    <div class="item active">
                                        @foreach ($product->images as $img)
                                            <img src="{{ asset('storage/products/85x84/' . $img->image) }}"
                                                data-full="{{ asset('storage/products/full/' . $img->image) }}"
                                                class="thumb-img" alt="" style="cursor: pointer;" />
                                        @endforeach
                                    </div>
                                </div>

        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30">
                            <img src="{{ $infor->avatar ? Storage::url($infor->avatar) : asset('admin/assets/images/users/5.jpg') }}"
                                class="rounded-circle" width="150" />
                            <h4 class="card-title m-t-10">{{ $infor->name }}</h4>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" action="/admin/profile/{{ $infor->id }}"
                            ...
                            <div pss="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Johnathan Doe" name="name"
                                        value="{{ $infor->name }}" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="email" placeholder="johnathan@admin.com" value="{{ $infor->email }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password" name="password" value="{{ $infor->password }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password" name="password_confirmation" value="{{ $infor->password }}"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="address" class="col-sm-12">Select Country</label>
                                <div class="col-sm-12">
